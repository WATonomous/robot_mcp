...
class TestConfigParser(unittest.TestCase):
    ...
    def test_topic_configs_loaded(self):
        ...
        try:
            ...
            request = GetParameters.Request()
            request.names = ['battery.topic', 'battery.msg_type', 'battery.plugin', 'battery.subscribe']
            ...
            self.assertEqual(response.values[1].string_value, 'sensor_msgs/msg/BatteryState')
            self.assertEqual(response.values[2].string_value, 'robot_mcp_sensor_msg_plugins::BatteryStatePlugin')
